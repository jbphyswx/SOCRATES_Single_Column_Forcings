...
function open_atlas_les_profile(flight_number::Int, )  
    ...
    this_dir = @__DIR__ # doesn't seem to work to use @__DIR__ directly as a variable
    RF_num = "RF" * string(flight_number,pad=2)
    obs_filename  = this_dir * "/" * RF_num * "_obs-based_SAM_input.nc" # e.g. https://atmos.uw.edu/~ratlas/RF12_obs-based_SAM_input.nc
